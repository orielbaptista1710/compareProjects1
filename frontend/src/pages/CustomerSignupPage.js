...
Exclusive Discounts on Projects            </li>
            <li>
              <FontAwesomeIcon icon={faCheck} className="check-icon" />
Zero Brokerage Fees            </li>
            <li>
              <FontAwesomeIcon icon={faCheck} className="check-icon" />
Direct Contact with Developers            </li>
            <li>
              <FontAwesomeIcon icon={faCheck} className="check-icon" />
Free Guidance for Home Loans            </li>
          </ul>
              ...
              <div className="password-requirements compact">
                {passwordRules.map((rule, idx) => (
                  <div className="requirement" key={idx}>
                    <FontAwesomeIcon
                      icon={rule.test(form.customerPassword) ? faCheck : faXmark}
                      className={rule.test(form.customerPassword) ? "valid" : "invalid"}
                    />
